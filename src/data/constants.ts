...
export const TRANSLATIONS: Record<Language, Record<string, string>> = {
  pt: {
    ...
    simGroupsTitle: 'Simular Fase de Grupos?',
    simGroupsDesc: 'Todos os placares da fase de grupos inseridos manualmente serão sobrescritos. A artilharia será recalculada.',
    simGroupsBtn: 'Sim, Simular Grupos',
    simFullTitle: 'Simular Copa Completa?',
    simFullDesc: 'Todos os placares de grupos e mata-mata serão sobrescritos e a artilharia recalculada. Esta ação não pode ser desfeita.',
    simFullBtn: 'Sim, Simular Tudo',
    pdfTitle: 'Baixar PDF da Tabela?',
    pdfDesc: 'O arquivo PDF com a tabela oficial da Copa do Mundo 2026 será baixado para o seu dispositivo.',
    pdfBtn: 'Sim, Baixar PDF',
    exportTitle: 'Exportar Dados?',
    exportDesc: 'Um arquivo de backup (JSON) com todos os seus placares, chaveamento e artilheiros será salvo no seu dispositivo.',
    exportConfirmBtn: 'Sim, Exportar',
    importTitle: 'Importar Dados?',
    importDesc: 'Todos os dados atuais (placares, chaveamento e artilharia) serão substituídos pelos dados do arquivo importado. Esta ação não pode ser desfeita.',
    importConfirmBtn: 'Sim, Importar',
  },
  en: {
    ...
    simGroupsTitle: 'Simulate Group Stage?',
    simGroupsDesc: 'All manually entered group stage scores will be overwritten. Top scorers will be recalculated.',
    simGroupsBtn: 'Yes, Simulate Groups',
    simFullTitle: 'Simulate Full Cup?',
    simFullDesc: 'All scores (groups and knockout) will be overwritten and scorers recalculated. This cannot be undone.',
    simFullBtn: 'Yes, Simulate All',
    pdfTitle: 'Download PDF?',
    pdfDesc: 'The official FIFA World Cup 2026 schedule PDF will be downloaded to your device.',
    pdfBtn: 'Yes, Download PDF',
    exportTitle: 'Export Data?',
    exportDesc: 'A backup file (JSON) with all your scores, knockout results and scorers will be saved to your device.',
    exportConfirmBtn: 'Yes, Export',
    importTitle: 'Import Data?',
    importDesc: 'All current data (scores, knockout and scorers) will be replaced by the data from the selected file. This cannot be undone.',
    importConfirmBtn: 'Yes, Import',
  },
  es: {
    ...
    simGroupsTitle: '¿Simular Fase de Grupos?',
    simGroupsDesc: 'Todos los marcadores de la fase de grupos ingresados manualmente serán sobreescritos. La tabla de goleadores será recalculada.',
    simGroupsBtn: 'Sí, Simular Grupos',
    simFullTitle: '¿Simular Copa Completa?',
    simFullDesc: 'Todos los marcadores (grupos y eliminatorias) serán sobreescritos y los goleadores recalculados. Esta acción no se puede deshacer.',
    simFullBtn: 'Sí, Simular Todo',
    pdfTitle: '¿Descargar PDF?',
    pdfDesc: 'El archivo PDF con el calendario oficial de la Copa Mundial FIFA 2026 se descargará en su dispositivo.',
    pdfBtn: 'Sí, Descargar PDF',
    exportTitle: '¿Exportar Datos?',
    exportDesc: 'Un archivo de respaldo (JSON) con todos sus marcadores, eliminatorias y goleadores se guardará en su dispositivo.',
    exportConfirmBtn: 'Sí, Exportar',
    importTitle: '¿Importar Datos?',
    importDesc: 'Todos los datos actuales (marcadores, eliminatorias y goleadores) serán reemplazados por los datos del archivo seleccionado. Esta acción no se puede deshacer.',
    importConfirmBtn: 'Sí, Importar',
  },
}
